...
#include "../Tarea4-v2-Buscaminas/minebutton.h"
...
QT_MOC_LITERAL(4, 41, 12) // "QMouseEvent*"
    ...
    "MineButton\0rightClicked\0\0mousePressEvent\0"
    "QMouseEvent*"
};
...
void MineButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MineButton::rightClicked)) {
                *result = 0;
                return;
            }
        }
