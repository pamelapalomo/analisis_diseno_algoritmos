...
int main(int argc, char** argv) {
	...
	y cada renglon restante contiene la definicion de la funcion de transicion, hacienod uso 
	...
	Siendo e: estado
		...
		En este repositorio se tienen tres ejemplos dearchivos de entrada:
